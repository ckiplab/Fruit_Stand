...
def train():
    ...
    parser.add_argument("--dataset_path", type=str, default="../data/buyer_aspect/dataset_train3386_valid423_reward_buyer_reply.json", help="Path or url of the dataset. ")
    parser.add_argument("--dataset_cache", type=str, default='../data/buyer_aspect/dataset_train3386_valid423_reward_buyer_reply_cache', help="Path or url of the dataset cache")
