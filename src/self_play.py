#----#
#usage: let the fine-tuned buyer&seller models talk to each other.
#----#
...
def main():
    ...
    Buyer = Agent(args, aspect='Buyer',use_HF_form=False) #HF_form = True: for RL version
    ...
    for dataset_name, items in Buyer.first_talks.items():
        ...
        with open (f'{args.model_checkpoint_seller}_OUTPUTS_of_self_play_423_maxlen{args.max_generate_length}.txt', 'w') as f:
            output_list = []
