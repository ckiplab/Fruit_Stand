...
def main():
    ...
    file_prefix_seller = make_logdir(f'RL_Both_{args.reward_baseline_type}_b{args.batch_size}_lr{args.lr}/Seller/epoch_00')
    file_prefix_buyer = make_logdir(f'RL_Both_{args.reward_baseline_type}_b{args.batch_size}_lr{args.lr}/Buyer/epoch_00')
