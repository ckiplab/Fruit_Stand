#----#
#usage: RL(train O'), merely RL without SL.
#----#
import logging
import time
import os
...
def main():
    ...
    parser.add_argument("--max_generate_length", type=int, default=30, help="Number of max_generate_length")
    ...
    file_prefix_seller = make_logdir(f'RL_Both_trainingset_{args.reward_baseline_type}_b{args.batch_size}_lr{args.lr}/Seller/epoch_00')
    file_prefix_buyer = make_logdir(f'RL_Both_trainingset_{args.reward_baseline_type}_b{args.batch_size}_lr{args.lr}/Buyer/epoch_00')
